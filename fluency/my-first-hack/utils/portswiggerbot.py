...
class Bot:
    ...
    def choose_topic(self, topic_name="cross-site-scripting", level=None):
        ...
        if level:
            extracted_links = [
                ...
                for link in links
                if link.find_element(By.TAG_NAME, "span").text == level
            ]
        else:
            extracted_links = [
    ...
    def obtain_lab_information(self, lab_url):
        ...
        paragraphs = description_section.find_elements(
            By.XPATH, ".//p[following-sibling::div[@class='container-buttons-left']]"
        )
