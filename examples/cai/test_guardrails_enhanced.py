...
from cai.sdk.agents import InputGuardrailTripwireTriggered, OutputGuardrailTripwireTriggered, Runner
...
async def test_guardrails():
    ...
    try:
        ...
        print("❌ Safe input wrongly blocked")
    ...
    try:
        ...
        print("❌ Base64 injection was NOT blocked at input stage")
    except InputGuardrailTripwireTriggered:
        print("✅ Base64 injection blocked at input guardrail!")
    except OutputGuardrailTripwireTriggered:
        print("✅ Base64 injection blocked at output guardrail!")
    ...
    if "Error: Blocked" in result:
        print("✅ Tool blocked base64-encoded dangerous command")
        print(f"   Response: {result}")
    else:
        print("❌ Tool executed dangerous command!")
