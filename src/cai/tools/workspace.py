"""Workspace management and safe filesystem tooling for Cerebro-AI.
...
class ProjectSpace:
    ...
    def from_environment(cls, env: Mapping[str, str] | None = None) -> ProjectSpace:
        ...
        explicit_active = source.get("CAI_WORKSPACE_ACTIVE_ROOT")
        if explicit_active:
        ...
        if _is_valid_workspace_name(explicit_name):
            ...
            _warn(f"Invalid CAI_WORKSPACE '{explicit_name}'. Using auto-generated run directory instead.")
    ...
    async def get_summary(self) -> Dict[str, Any]:
        ...
        try:
            def _scan() -> WorkspaceSummary:
                ...
                case_name = os.getenv("CAI_WORKSPACE") or self._root.name
...
def _get_workspace_dir() -> str:
    workspace_active_root = os.getenv("CAI_WORKSPACE_ACTIVE_ROOT")
