...
class CerebroNmapTool:
    ...
    async def _scan_async(
        ...
        *,
        ...
        with CLI_UTILS.managed_env_context(base_env=clean_env) as runtime_env:
            ...
            async def _read_stdout() -> None:
                ...
                while True:
                    ...
                    stdout_chunks.append(self._secure.redact_text(text, redactions))
        ...
        if process.returncode not in (0, None):
            ...
            return self._error("scan_failed", stderr_text or f"nmap exited with code {process.returncode}")
    ...
    def _allowed_scope_tokens() -> List[str]:
        raw = ",".join([
            os.getenv("CAI_ENGAGEMENT_SCOPE", ""),
            os.getenv("CAI_ALLOWED_TARGETS", ""),
        ])
