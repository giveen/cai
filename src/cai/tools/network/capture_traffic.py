"""Hardened forensic network capture engine for Cerebro-AI."""
...
class CerebroCaptureTool:
    ...
    def _permitted_interfaces(self) -> set[str]:
        config_keys = [
            "CAI_CAPTURE_PERMITTED_INTERFACES",
            "CAI_PERMITTED_CAPTURE_INTERFACES",
        ...
        for key in config_keys:
            ...
            if value and value != "Not set":
                ...
                break
        if not raw:
            raw = os.getenv("CAI_CAPTURE_PERMITTED_INTERFACES", "")
