...
load_dotenv()
_one_tool_prompt = load_prompt_template("prompts/system_web_pentester.md")
...
one_tool_agent = Agent(
  name="Cerebro Atomic Task Runner",
  description="Stateless surgical runner used when dispatcher already knows the exact tool and parameters.",
