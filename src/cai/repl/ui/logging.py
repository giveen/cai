"""Cerebro-AI forensic audit logging utilities for REPL and UI telemetry.
...
class CerebroLogger:
    ...
    def _env_show_thought() -> bool:
        value = str(os.environ.get("CAI_THINK", os.environ.get("CAI_LOG_THOUGHTS", "false"))).strip().lower()
