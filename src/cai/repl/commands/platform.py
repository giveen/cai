"""Platform capability auditor for CAI REPL.
...
class SystemAuditor:
    ...
    def _allow_fingerprint(self) -> bool:
        key = "CAI_PLATFORM_ALLOW_FINGERPRINT"
...
class PlatformCommand(FrameworkCommand):
    ...
    def help(self) -> str:
        return (
            ...
            "Privacy: host identifiers remain redacted unless CAI_PLATFORM_ALLOW_FINGERPRINT=true"
        )
