...
class CompactCommand(Command):
    ...
    def _show_help_menu(self):
        ...
        console.print(
            "  [bold]/compact[/bold]                      - Summarize current conversation"
        )
        console.print(
            "  [bold]/compact model[/bold]                - Configure model for compaction"
        )
        console.print(
            "  [bold]/compact prompt[/bold]               - Set custom summarization prompt"
        )
            ...
            if self.compact_model:
                ...
                try:
                    result = MEMORY_COMMAND_INSTANCE.handle_save(
                        [memory_name], preserve_history=False
                    )
                finally:
