"""Base module for the CAI REPL command framework.
...
class FrameworkCommand(ABC):
    """Abstract base class for all CAI REPL commands.
    ...
    def _run_execute(self, args: List[str]) -> bool:
        ...
        if loop and loop.is_running():
            # We're inside an async context (e.g. Textual TUI).
